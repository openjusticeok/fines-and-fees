...
# connect_ojo()
# oscn_fees <- dbGetQuery(ojo_db,
#                         "SELECT court, casenum, YEAR(min_date) AS fee_year, SUM(fee_amt) as total_fees
#                         FROM oscn_mins_2008CF
#                         WHERE fee_amt IS NOT NULL
#                         AND min_date > 2013-12-31
#                         AND fee_amt < 200000
#                         GROUP BY court, casenum, fee_year"
#                         )
